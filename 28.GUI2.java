...
class FrameCrt extends  WindowAdapter implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent obj)
    {
        try 
        {
            ...
            if(((obj.getSource() != b1) && (obj.getSource() != b2) && (obj.getSource() != b3) && (obj.getSource() != b4) && (obj.getSource() != b15) && (obj.getSource() != b16)))
            {
                if(obj.getSource()== b5)
                { //b1 for number 1
                    zt=l.getText();
                ...
                {
                    zt=l.getText();
                    z=zt+"2";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b7)
                {
                    zt=l.getText();
                    z=zt+"3";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b8)
                {
                    zt=l.getText();
                    z=zt+"4";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b9)
                {
                    zt=l.getText();
                    z=zt+"5";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b10)
                {
                    zt=l.getText();
                    z=zt+"6";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b11)
                {
                    zt=l.getText();
                    z=zt+"7";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b12)
                {
                    zt=l.getText();
                    z=zt+"8";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b13)
                {
                    zt=l.getText();
                    z=zt+"9";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
                if(obj.getSource() == b14)
                {
                    zt=l.getText();
                    z=zt+"0";// 1 will merged at the end of the previous value
                    l.setText(z);
                }
            }
            else if(((obj.getSource() == b1) || (obj.getSource() == b2) || (obj.getSource() == b3) || (obj.getSource() == b4) || (obj.getSource() == b15) || (obj.getSource() == b16)))
            {
                no1 = Integer.valueOf(z);
